...
## Results
* Naive Random Oversampling: an accuracy score of 65.7%, a precision score of 1% for high-risk, and a 100% for low-risk. A recall score of 71% for high-risk and 60% for low-risk were produced with this model.
